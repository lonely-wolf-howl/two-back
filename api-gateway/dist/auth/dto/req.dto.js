...
exports.SigninReqDto = exports.SignupReqDto = exports.Gender = void 0;
...
], SignupReqDto.prototype, "username", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*]).{8,30}$/),
    __metadata("design:type", String)
], SignupReqDto.prototype, "confirm", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
...
], SignupReqDto.prototype, "birthyear", void 0);
class SigninReqDto {
}
